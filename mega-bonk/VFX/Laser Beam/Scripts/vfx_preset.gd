...
@export_range(0.1, 20.0, 0.1) var noise_frequency: float = 1.0
...
@export_range(0.00, 3.0, 0.01) var trail_width_end: float = 0.15
...
@export_range(0.0, 1.0, 0.001) var head_distort_amount: float = 0.32
@export_range(0.0, 20.0, 0.01) var head_distort_speed: float = 3.0
...
@export_range(0.01, 5.0, 0.01) var ring_radius_m: float = 0.85
@export_range(0.001, 2.0, 0.001) var ring_thickness_m: float = 0.01
@export_range(0.0, 1.0, 0.001) var ring_pulse_amount: float = 0.18
@export_range(0.0, 20.0, 0.01) var ring_pulse_speed: float = 2.5
